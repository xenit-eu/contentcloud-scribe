...
//    @Test
//    void test(@TempDir Path temp) throws IOException {
//
//        var contributor = new EntityModelSourceCodeProjectContributor(projectDescription(),
//                new EntityModel(List.of(
//                        new Entity("organization",
//                                List.of(Attribute.builder().name("name").type("STRING").build()),
//                                List.of(Relation.builder().build()))
//                )));
//
//        contributor.contribute(temp);
//
//        var path = temp.resolve("src").resolve("main").resolve("java")
//                .resolve("eu/xenit/contentcloud/scribe/test")
//                .resolve("model")
//                .resolve("Organization.java");
//
//        assertThat(path).isRegularFile().hasContent("");
//    }

//    private static ScribeProjectDescription projectDescription() {
//        ScribeProjectDescription description = new ScribeProjectDescription();
//        description.useLombok(true);
//        description.setBuildSystem(new GradleBuildSystem());
//        description.setLanguage(new JavaLanguage());
//        description.setPackageName("eu.xenit.contentcloud.scribe.test");
//        return description;
//    }
}